...
│   │   └── courses/            # 各业务模块专用的样式
│   │       ├── line-search/    # 一维搜索样式 (common, observation, comparison, application)
│   │       ├── linear-programming/ # 线性规划样式 (introduction, simplex)
│   │       └── svm-smo/        # SVM 样式 (introduction, kernel-trick, smo)
│   ├── js/
│   │   ├── lib/                # 第三方库 (d3.js, math.js, MathJax)
│   │   ├── common/             # 项目公共逻辑 (ai-sidebar.js)
│   │   └── courses/            # 实验业务逻辑
│   │       ├── line-search/    # 一维搜索逻辑
│   │       │   ├── range-search/ # 区间收缩法 (golden-section, fibonacci, bisection)
│   │       │   ├── point-search/ # 点搜索法 (algorithms, visualization)
│   │       │   └── application.js # 应用实验逻辑
│   │       ├── linear-programming/ # 线性规划逻辑 (introduction, simplex)
│   │       └── svm-smo/        # SVM 逻辑 (introduction, kernel-trick, smo)
│   ├── vendor/
...
│       │   ├── point-search/   # 点搜索法 (introduction, observation, comparison)
│       │   └── application.html # 应用实验页面
│       ├── linear-programming/ # 线性规划 (introduction, index, simplex)
│       └── svm-smo/            # 支持向量机 (introduction, index, kernel-trick, smo)
├── docs/                       # 项目文档与实验指导书
│   ├── 公式/                   # 算法数学原理
│   └── 实验指导书/             # Agent 使用的业务文档
